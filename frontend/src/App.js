      ...
      <BrowserRouter>
        ...
        <div className="pages">
          <Routes>
            ...
            <Route
              path="/navbar/data-input/bpentry"
              element={<BPEntryForm />}
            />
            ...
            <Route
              path="/leaderboards/situational"
              element={<MaxEVSituational />}
            />
            <Route
              path="/leaderboards/highvelocity"
              element={<MaxEVHighVelo />}
            />
            <Route
              path="/leaderboards/coachpitch"
              element={<MaxEVCoachPitch />}
            />
          </Routes>
        </div>
      </BrowserRouter>
